...
format_and_setup_disk
clone_nixos_config
# this was needed for the proxy connection when ipv4 wasn't enabled and hetzner's ipv6 wan wasn't working
#setup_reverse_ssh_access
#connect_proxy

ssh bash -l -c nixos-install
